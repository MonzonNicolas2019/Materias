...
%Solo llaves es para ambas paginas.
	{   
   %\sethead{\includegraphics[width=3.7cm]{../images/UBA_LARGE}}{\Title}{\Author}\headrule
	\sethead{\includegraphics[width=3.7cm]{../images/UBA_LARGE}}
...
\chapter{Cinem\'atica}
\begin{enumerate}
	\item \input{guide_1/exercise_01}
	\item \input{guide_1/exercise_02}
	\item \input{guide_1/exercise_03}
\end{enumerate}
